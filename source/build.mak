...
# default gcc args
CC_ARGS := -Werror -m32
LINKER_ARGS := -m elf_i386 -nostdlib 
...
# Assembly File
$(OBJ_DIR)/%.o: %.S $(call rwildcard,$(INCLUDE_DIR),**.h)
	@mkdir -p $(dir $@)
	gcc $(CC_ARGS) -c -DASM_FILE $(INCLUDE_ARG) -o $@ $<

# C File
$(OBJ_DIR)/%.o: %.c $(call rwildcard,$(INCLUDE_DIR),**.h)
	@mkdir -p $(dir $@)
	gcc $(CC_ARGS) -c -DC_FILE $(INCLUDE_ARG) -o $@ $<

# C++ File
$(OBJ_DIR)/%.o: %.cpp $(call rwildcard,$(INCLUDE_DIR),**.h)
	@mkdir -p $(dir $@)
	gcc $(CC_ARGS) -c -DCPP_FILE $(INCLUDE_ARG) -o $@ $<

# Asm Python Gen
$(OBJ_DIR)/%.o: %.S.gen.py $(call rwildcard,$(INCLUDE_DIR),**.h)
	@mkdir -p $(dir $@)
...
# C Python Gen
$(OBJ_DIR)/%.o: %.c.gen.py $(call rwildcard,$(INCLUDE_DIR),**.h)
	@mkdir -p $(dir $@)
...
# C++ Python Gen
$(OBJ_DIR)/%.o: %.cpp.gen.py $(call rwildcard,$(INCLUDE_DIR),**.h)
	@mkdir -p $(dir $@)
